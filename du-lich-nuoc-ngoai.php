	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<img style="width:350px;height:190px;" src="/traveltour/img/nuocngoai.jpg">
			</div>
			<div class="col-md-8">
				<h1><a href="du-lich-viet-nam.php"><span class="title" style="color: orange;">Du lịch nước ngoài</span></a></h1><hr>
	...
	<div class="container">
		<div class="col-md-12 text-center">
			<h2 style="color:#fc6600;font-family: 'Roboto';font-size: 28px;">
				Danh sách tour du lịch nước ngoài
			</h2>
		</div>
	<?php 
		$sqltotal = $dbc->prepare('SELECT COUNT(IDSubca) as total FROM subcategory WHERE IDCat=2');
	$sqltotal->execute();
    ...
    endforeach;
 	//tim limit page va current page
      ...
      $sql = $dbc->prepare('SELECT * FROM subcategory WHERE IDCat=2'.$limit) ; // ok lun
		//$sql=$dbc->prepare("SELECT * FROM subcategory WHERE IDCat=2");
		$sql->execute();
  ...
  <ul class="pagination">
    ...
    <?php 
      ...
      { ?>
        <li class="page-item"><a class="page-link" href="du-lich-nuoc-ngoai.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
      <?php } ?>
    <li class="page-item">
